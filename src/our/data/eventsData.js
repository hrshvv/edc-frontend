...
export const eventsData = [
  {
    ...
    shortDescription:
      'A high-intensity startup simulation where ideas are tested, built, and battle-proven across 5 brutal rounds.',
    description:
      "Founder's Pit 2026 was a one-day startup simulation by EDC, JSS University Noida. Teams bid for problem statements, built startups, survived a crisis round, and pitched to industry judges.",
    poster: 'https://res.cloudinary.com/dh8cqlngr/image/upload/q_auto,f_auto,b_rgb:0a0014/v1774820657/Founder_s_Pit_kvfeqt.png',
    date: '2026-04-18',
    location: 'AB3, Campus',
    attendees: '100+',
    ...
    winner: null,
    highlights: [
      '5-round startup simulation',
      'Strategic bidding using virtual capital',
  ...
  },
  {
    ...
    shortDescription:
      'An interactive session helping first-year students build a strong and professional digital presence on LinkedIn.',
    description:
  ...
  },
  {
    ...
    title: 'Expert Talk',
    shortDescription:
      'An insightful session on Stock Market, Finance, and Investing designed to help students navigate financial markets with confidence.',
    description:
  ...
  {
    id: 1,
    slug: 'eureka-road-to-enterprise-2025',
    title: 'EDCxEureka! Road to Enterprise 2025',
    shortDescription:
      'A dynamic platform for aspiring innovators and entrepreneurs to pitch their ideas under NEC 2025 by E-Cell IIT Bombay.',
    description:
  ...
  },
  {
    ...
    shortDescription:
      "The beginning of a new entrepreneurial journey — introducing freshers to EDC's vision, initiatives, and opportunities.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      'A platform for students to express their views on Entrepreneurship Problems on Campus under NEC 2025.',
    description:
...
export const getCategoryColor = category => {
  switch (category) {
    ...
    case 'Networking':
      return { bg: 'rgba(5, 177, 222, 0.15)', text: '#05B1DE', border: 'rgba(5, 177, 222, 0.3)' };
    case 'Event':

...
const FloatingParticle = ({ delay, size, x, duration }) => (
  <div
    ...
    style={{
      ...
      bottom: '-5%',
      background:
        'radial-gradient(circle,rgba(215,118,255,.6) 0%,transparent 70%)',
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background:
            'radial-gradient(circle,rgba(94,12,159,.18) 0%,rgba(123,47,190,.07) 40%,transparent 70%)',
          transition: 'left .8s ease-out,top .8s ease-out',
        }}
      />

      <div
        className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] h-[320px] pointer-events-none"
        style={{
          background:
            'radial-gradient(ellipse at center,rgba(123,47,190,.22) 0%,transparent 65%)',
          filter: 'blur(40px)',
        }}
      />
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        <div
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#7B2FBE]/30 bg-[#1B002B]/40 backdrop-blur-md mb-8"
        ...
        <p
          className="text-white/55 text-base sm:text-lg max-w-xl mx-auto mt-6 leading-relaxed"
          style={{ animation: 'fadeSlideUp .8s ease-out .2s both' }}
        >
          A high-intensity startup simulation where ideas are tested, built, and
          battle-proven.
        </p>
        ...
        >
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#1B002B]/70 border border-[#7B2FBE]/40 backdrop-blur-md"
            >
              <span>{m.icon}</span>
        ...
        <div
          className="mt-10"
          style={{ animation: 'fadeSlideUp .8s ease-out .45s both' }}
        >
          <button
            onClick={() =>
              document
                .getElementById('about-fp')
      ...
      <div className="absolute bottom-0 left-0 w-full py-4 bg-[#1B002B]/80 backdrop-blur-xl border-t border-[#7B2FBE]/40 overflow-hidden flex flex-wrap justify-center gap-x-6 gap-y-2 px-4 z-20 shadow-[0_-15px_40px_rgba(123,47,190,.15)]">
        {[
          ...
          <div key={i} className="flex items-center gap-2">
            <svg
              className="size-3.5 text-[#D776FF] fill-current"
              viewBox="0 0 24 24"
            >
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
            </svg>
            <span className="text-white/75 text-[10px] sm:text-xs font-bold tracking-widest uppercase">
              {item}
            </span>
          </div>
        ))}
...
const About = () => (
  <section
    id="about-fp"
    className="relative py-24 sm:py-32 px-4 sm:px-6 bg-[#05000A] border-t border-[#7B2FBE]/20 overflow-hidden"
  >
    ...
    <div
      ...
      style={{
        background:
          'radial-gradient(circle,rgba(94,12,159,.18) 0%,transparent 70%)',
        filter: 'blur(80px)',
      }}
    />
    ...
    <div className="max-w-6xl mx-auto relative z-10 grid lg:grid-cols-2 gap-16 items-center">
      <div>
        <span className="text-[#D776FF] font-bold tracking-[.22em] uppercase text-xs">
          About
        </span>
        <h2 className="text-4xl sm:text-6xl font-black text-white mt-4 leading-[1.05]">
          Where Ideas Get
          <br />
          <span className="fp-subtitle">Battle-Tested</span>
        </h2>
        <p className="text-white/60 text-base sm:text-lg leading-relaxed mt-6">
          Founder's Pit 2026 was successfully conducted as a{' '}
          <span className="text-white/90 font-semibold">
            high-intensity live startup simulation
          </span>{' '}
          event on{' '}
          <span className="text-white/90 font-semibold">18 April 2026</span> at{' '}
          <span className="text-white/90 font-semibold">
            AB3 Campus, JSS University Noida
          </span>
          .
        </p>
        <p className="text-white/60 text-base sm:text-lg leading-relaxed mt-4">
          Designed to provide participants with a real startup ecosystem
          experience, the event challenged teams to navigate the complete
          journey of building a startup — through gamified challenges, strategic
          decision-making, crisis-solving, teamwork, and final pitching.
        </p>
        <p className="text-white/60 text-base sm:text-lg leading-relaxed mt-4">
          A standout feature was the{' '}
          <span className="text-[#D776FF] font-semibold">
            strategic bidding portal
          </span>{' '}
          developed by the organising team, which added a dynamic, realistic
          layer to the entrepreneurial simulation — creating an immersive,
          competitive environment for aspiring innovators and future founders.
        </p>
        ...
        <div className="flex flex-col gap-3 mt-8">
          {[
            {
              label: 'THE BID',
              desc: 'Live auction using virtual capital to secure your chosen problem statement.',
            },
            {
              label: 'THE BUILD',
              desc: 'Design products, craft business models, navigate unexpected crises.',
            },
            {
              label: 'THE PITCH',
              desc: 'Present your battle-tested startup to industry judges under intense Q&A.',
            },
          ].map((p, i) => (
            <div
              key={i}
              className="fp-card p-4 rounded-2xl flex items-center gap-4"
            >
              <div className="size-10 rounded-xl bg-[#5E0C9F]/40 flex items-center justify-center shrink-0 text-[#D776FF] font-black text-xs">
                0{i + 1}
              </div>
              <div>
                <h4 className="font-black text-white text-sm tracking-wider">
                  {p.label}
                </h4>
      ...
      <div className="relative h-[420px] sm:h-[500px]">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1B002B] to-[#3A036E] rounded-3xl fp-card overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: 'radial-gradient(#D776FF 1px,transparent 1px)',
          ...
          <div className="absolute top-8 left-8 right-8 bottom-8">
            ...
            >
              <div className="flex justify-between items-center mb-3">
                <span className="text-[#D776FF]/80 text-xs font-bold uppercase tracking-wider">
                  270+ Participants
                </span>
                <svg
                  className="size-4 text-[#D776FF]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
              ...
              <div className="flex items-end gap-1.5 h-16 w-full">
                {[30, 50, 40, 70, 60, 90, 80].map((h, i) => (
                  <div
                    key={i}
                    className="flex-1 bg-gradient-to-t from-[#7B2FBE] to-[#D776FF] rounded-sm opacity-80"
                    style={{ height: `${h}%` }}
                  />
                ))}
              </div>
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <span className="text-[#D776FF] text-xs font-bold">
                  Bidding Portal
                </span>
                <img
                  src="https://res.cloudinary.com/dh8cqlngr/image/upload/q_auto/f_auto/v1774820657/Founder_s_Pit_kvfeqt.png"
...
const TheEdge = () => {
  const edges = [
    ...
    {
      num: '02',
      title: 'Strategic Bidding Portal',
    ...
    {
      num: '05',
      title: 'Startup Ecosystem Experience',
    ...
    {
      num: '06',
      title: 'Nurturing Future Founders',
  ...
  return (
    <section className="py-24 sm:py-32 px-4 sm:px-6 bg-[#000000] border-t border-[#7B2FBE]/15 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse,rgba(94,12,159,.2) 0%,transparent 65%)',
          filter: 'blur(60px)',
        }}
      />
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-6xl font-black text-white mt-4">
            The <span className="fp-subtitle">Edge</span>
          </h2>
          <p className="text-white/50 text-lg mt-4 max-w-2xl mx-auto">
            Six reasons Founder's Pit is unlike any other campus competition.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {edges.map((e, i) => (
            <div
              key={i}
              className="fp-card p-7 rounded-3xl group hover:-translate-y-1.5 transition-transform duration-300 relative overflow-hidden"
            >
              <div className="absolute top-4 right-4 text-[4rem] font-black text-[#D776FF]/5 group-hover:text-[#D776FF]/10 leading-none transition-colors select-none">
                {e.num}
              </div>
              <div className="size-12 rounded-xl bg-[#1B002B] border border-[#7B2FBE]/40 flex items-center justify-center mb-5 group-hover:border-[#D776FF]/50 transition-colors">
                {e.icon}
              </div>
              <h3 className="text-lg font-black text-white mb-2 group-hover:text-[#D776FF] transition-colors">
                {e.title}
              </h3>
  ...
  const stats = [
    {
      ...
      sub: 'Teams registered for Round 1',
    },
    {
      value: '270+',
      label: 'Participants',
      sub: 'Students competed across all rounds',
    },
    {
      value: '100K+',
      label: 'Social Impressions',
      sub: 'Social media reach across platforms',
    },
  ...
  return (
    <section className="py-24 sm:py-32 px-4 sm:px-6 bg-[#05000A] border-t border-[#7B2FBE]/20 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle,rgba(123,47,190,.12) 0%,transparent 65%)',
          filter: 'blur(80px)',
        }}
      />
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-6xl font-black text-white mt-4">
            The <span className="fp-subtitle">Numbers</span>
          </h2>
          <p className="text-white/50 text-lg mt-4 max-w-2xl mx-auto">
            Founder's Pit 2026 brought together the brightest student founders
            under one roof.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          {stats.map((s, i) => (
            <div
              key={i}
              className="fp-card p-6 sm:p-8 rounded-3xl text-center group hover:-translate-y-1 transition-transform duration-300"
            >
              <div className="text-4xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-[#D776FF] to-[#7B2FBE] mb-1 leading-none">
                {s.value}
              </div>
              <div className="text-white font-bold text-sm sm:text-base mt-2 group-hover:text-[#D776FF] transition-colors">
                {s.label}
              </div>
        ...
        <div className="fp-card rounded-3xl p-8 sm:p-10 border border-[#D776FF]/25">
          <h3 className="text-2xl font-black text-white mb-6 text-center">
            Who Could Enter <span className="fp-subtitle">The Pit</span>
          </h3>
            ...
            {[
              {
                num: '01',
                title: 'Campus Only',
                desc: 'Exclusively for JSS University & JSSATEN students.',
              },
              {
                num: '02',
                title: '1st & 2nd Year',
                desc: 'Freshers with ideas and sophomores ready to execute.',
              },
              {
                num: '03',
                title: 'Team of 2–4',
                desc: 'No solo warriors. Collaboration is mandatory in the Pit.',
              },
            ].map((e, i) => (
              <div key={i} className="text-center">
                <div className="mx-auto size-14 bg-[#1B002B] rounded-full flex items-center justify-center border border-[#7B2FBE]/40 mb-3 text-[#D776FF] font-black text-sm">
                  {e.num}
                </div>
...
const JudgesMentors = () => {
  ...
  const PersonCard = ({ person, role }) => (
    <div className="fp-card rounded-3xl p-7 group hover:-translate-y-2 transition-transform duration-400 relative overflow-hidden h-full flex flex-col justify-center">
      <div className="absolute top-5 right-5">
        <span
          className={`text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border ${role === 'Judge' ? 'bg-[#D776FF]/10 text-[#D776FF] border-[#D776FF]/25' : 'bg-[#7B2FBE]/15 text-[#C9A3EF] border-[#7B2FBE]/30'}`}
        >
          {role}
        </span>
      </div>

      <h3 className="text-xl font-black text-white group-hover:text-[#D776FF] transition-colors pr-16">
        {person.name}
      </h3>
      <p className="text-[#D776FF]/80 text-xs font-semibold mt-1 mb-1 tracking-wide">
        {person.title}
      </p>
  ...
  return (
    <section className="py-24 sm:py-32 px-4 sm:px-6 bg-[#05000A] border-t border-[#7B2FBE]/20 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle,rgba(94,12,159,.18) 0%,transparent 68%)',
          filter: 'blur(80px)',
        }}
      />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-6xl font-black text-white mt-4">
            Judges & <span className="fp-subtitle">Mentors</span>
          </h2>
          <p className="text-white/50 text-lg mt-4 max-w-2xl mx-auto">
            Industry leaders who evaluated, challenged, and guided our founders
            through the Pit.
          </p>
        </div>

        <div className="mb-10">
          <h3 className="text-sm font-black text-white/50 uppercase tracking-[.3em] text-center mb-8">
            Our Judges
          </h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {judges.map((j, i) => (
              <PersonCard key={i} person={j} role="Judge" />
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {mentors.map((m, i) => (
              <PersonCard key={i} person={m} role="Mentor" />
            ))}
          </div>
        </div>
      </div>
...
const TheGauntlet = () => {
  ...
  const rounds = [
    {
      ...
      stats: [
        '70+ registrations (270+ participants)',
        '27 shortlisted teams (100+ participants)',
      ],
    ...
    },
    {
      ...
      stats: [
        '9 problem statements auctioned',
        '24 teams competed in the bidding war',
      ],
    ...
    },
    {
      ...
      stats: [
        'Each team paired with a dedicated mentor',
        'Real-time feedback and strategic guidance',
      ],
    ...
    },
    {
      ...
      stats: [
        'Unexpected economic & operational crises',
        'Entire strategy pivoted on the fly',
      ],
    ...
    },
    {
      ...
      stats: [
        'Elite panel of industry judges',
        'Rigorous Q&A testing robustness of solutions',
      ],
  ...
  return (
    <section
      ref={containerRef}
      id="event-flow"
      className="py-32 px-4 sm:px-6 relative overflow-hidden bg-gradient-to-b from-[#000000] to-[#05000A] border-t border-[#7B2FBE]/20"
    >
      <div className="absolute inset-0 fp-grid-bg opacity-20 pointer-events-none" />
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-24">
          ...
          <h2 className="text-5xl sm:text-7xl font-black text-white mt-4">
            Event <span className="fp-subtitle">Flow</span>
          </h2>
          <p className="text-white/50 text-xl mt-6 max-w-2xl mx-auto">
            Five rounds. Each testing a different dimension of entrepreneurial
            ability.
          </p>
        </div>
              ...
              >
                ...
                >
                  <div className="fp-card p-8 sm:p-10 rounded-3xl w-full max-w-lg hover:-translate-y-2 transition-transform duration-500 border border-[#7B2FBE]/30 hover:border-[#D776FF]/70 group relative overflow-hidden bg-[#0A0014]/80 text-left">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-black text-white mb-4 group-hover:text-[#D776FF] transition-colors">
                      {round.title}
                    </h3>
                    ...
                    <div className="space-y-2">
                      {round.stats.map((s, si) => (
                        <div key={si} className="flex items-center gap-2">
                          ...
                          <span className="text-[#D776FF]/70 text-xs font-semibold">
                            {s}
                          </span>
                        </div>
                      ))}
...
const Footer = () => (
  <footer className="py-10 px-4 bg-[#000000] border-t border-[#7B2FBE]/20 text-center">
    ...
    <p className="text-white/30 text-xs">
      © 2026 EDC, JSS University Noida · Founder's Pit · All rights reserved.
    </p>
  </footer>
);
